...
bool UTP_WeaponComponent::AttachWeapon(AGASMultiplayerArenaCharacter* TargetCharacter)
{
	...
	// Give the shoot ability to the character.
	Character->GiveAbility(UGA_Shoot::StaticClass());
